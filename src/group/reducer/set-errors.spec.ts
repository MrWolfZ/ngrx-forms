...
describe(`form group ${setErrorsReducer.name}`, () => {
  ...
  it('should update state if there are no errors', () => {
    ...
    const resultState = setErrorsReducer(state, SetErrorsAction(FORM_CONTROL_ID, {}));
  ...
  it('should throw if trying to set invalid error value', () => {
    ...
    expect(() => setErrorsReducer(INITIAL_STATE, SetErrorsAction(FORM_CONTROL_ID, { _inner: true }))).toThrowError();
  });

  it('should aggregate child errors', () => {
    const errors = { required: true };
    const resultState = setErrorsReducer(INITIAL_STATE, SetErrorsAction(FORM_CONTROL_INNER_ID, errors));
  ...
  it('should aggregate child errors for group children', () => {
    const errors = { required: true };
    const resultState = setErrorsReducer(INITIAL_STATE_FULL, SetErrorsAction(FORM_CONTROL_INNER3_ID, errors));
  ...
  it('should aggregate child errors for array children', () => {
    const errors = { required: true };
    const resultState = setErrorsReducer(INITIAL_STATE_FULL, SetErrorsAction(FORM_CONTROL_INNER5_ID, errors));
  ...
  it('should aggregate nested child errors for group', () => {
    const errors = { required: true };
    const resultState = setErrorsReducer(INITIAL_STATE_FULL, SetErrorsAction(FORM_CONTROL_INNER4_ID, errors));
  ...
  it('should aggregate nested child errors for array', () => {
    const errors = { required: true };
    const resultState = setErrorsReducer(INITIAL_STATE_FULL, SetErrorsAction(FORM_CONTROL_INNER5_0_ID, errors));
  ...
  it('should aggregate multiple child errors', () => {
    ...
    const errors2 = { min: 0 };
    let resultState = setErrorsReducer(INITIAL_STATE_FULL, SetErrorsAction(FORM_CONTROL_INNER_ID, errors1));
    resultState = setErrorsReducer(resultState, SetErrorsAction(FORM_CONTROL_INNER3_ID, errors2));
  ...
  it('should track child errors and own errors when own errors are changed', () => {
    ...
    const resultState = setErrorsReducer(state, SetErrorsAction(FORM_CONTROL_ID, errors1));
