...
describe(`form group ${setValueReducer.name}`, () => {
  ...
  it('should create child states on demand', () => {
    ...
    const resultState = setValueReducer<FormGroupValue>(INITIAL_STATE, SetValueAction(FORM_CONTROL_ID, value));
    expect(resultState.value).toEqual(value);
  ...
  it('should remove child states on demand', () => {
    const value = { inner: 'A', inner2: 'B' };
    let resultState = setValueReducer<FormGroupValue>(INITIAL_STATE, SetValueAction(FORM_CONTROL_ID, value));
    const value2 = { inner: 'A' };
    resultState = setValueReducer(resultState, SetValueAction(FORM_CONTROL_ID, value2));
  ...
  it('should remove child states on demand when value is empty', () => {
    ...
    const resultState = setValueReducer<FormValue>(state, SetValueAction(id, {}));
  ...
  it('should aggregate child values', () => {
    const value = 'A';
    const resultState = setValueReducer(INITIAL_STATE, SetValueAction(FORM_CONTROL_INNER_ID, value) as any);
  ...
  it('should aggregate child values for group children', () => {
    let resultState = setValueReducer<FormGroupValue>(
      INITIAL_STATE,
      SetValueAction(FORM_CONTROL_ID, { inner: 'A', inner3: { inner4: 'C' } }),
    );
    const value = { inner4: 'D' };
    resultState = setValueReducer(resultState, SetValueAction(FORM_CONTROL_INNER3_ID, value) as any);
  ...
  it('should aggregate child values for array children', () => {
    let resultState = setValueReducer<FormGroupValue>(
      INITIAL_STATE,
      SetValueAction(FORM_CONTROL_ID, { inner: 'A', inner5: ['C'] }),
    );
    const value = ['D'];
    resultState = setValueReducer(resultState, SetValueAction(FORM_CONTROL_INNER5_ID, value) as any);
  ...
  it('should aggregate nested child values in groups', () => {
    ...
    const value = 'D';
    resultState = setValueReducer(resultState, SetValueAction(FORM_CONTROL_INNER4_ID, value) as any);
  ...
  it('should aggregate nested child values in arrays', () => {
    ...
    const value = 'D';
    resultState = setValueReducer(resultState, SetValueAction(FORM_CONTROL_INNER5_0_ID, value) as any);
