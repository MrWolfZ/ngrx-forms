...
describe(`form group ${disableReducer.name}`, () => {
  ...
  it('should disable group children', () => {
    const resultState = disableReducer(INITIAL_STATE_FULL, DisableAction(FORM_CONTROL_ID));
  ...
  it('should forward actions to children', () => {
    const resultState = disableReducer(INITIAL_STATE, DisableAction(INITIAL_STATE.controls.inner.id));
