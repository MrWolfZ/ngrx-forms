...
describe(`form group ${addControlReducer.name}`, () => {
  it('should create child state for control child', () => {
    const value = 'B';
    const action = AddGroupControlAction(FORM_CONTROL_ID, 'inner2', value);
  ...
  it('should create child state for group child', () => {
    ...
    const action = AddGroupControlAction(FORM_CONTROL_ID, 'inner3', value);
    const resultState = addControlReducer<FormGroupValue>(INITIAL_STATE, action);
  ...
  it('should create child state for array child', () => {
    const value = ['A'];
    const action = AddGroupControlAction(FORM_CONTROL_ID, 'inner5', value);
    const resultState = addControlReducer<FormGroupValue>(INITIAL_STATE, action);
  ...
  it('should throw if trying to add existing control', () => {
    const action = AddGroupControlAction(FORM_CONTROL_ID, 'inner', '');
  ...
  it('should forward actions to children', () => {
    ...
    const value = 'B';
    const action = AddGroupControlAction(state.controls.inner.id, 'inner2', value);
