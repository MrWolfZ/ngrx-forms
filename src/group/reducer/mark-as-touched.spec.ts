...
describe(`form group ${markAsTouchedReducer.name}`, () => {
  ...
  it('should mark itself and all children recursively as touched', () => {
    const resultState = markAsTouchedReducer(INITIAL_STATE_FULL, MarkAsTouchedAction(FORM_CONTROL_ID));
  ...
  it('should not update state if all children are marked as touched recursively', () => {
    const resultState = markAsTouchedReducer(INITIAL_STATE_FULL_TOUCHED, MarkAsTouchedAction(FORM_CONTROL_ID));
  ...
  it('should forward actions to children', () => {
    const resultState = markAsTouchedReducer(INITIAL_STATE, MarkAsTouchedAction(INITIAL_STATE.controls.inner.id));
