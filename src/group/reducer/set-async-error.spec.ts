...
describe(`form group ${setAsyncErrorReducer.name}`, () => {
  ...
  it('should update state with error', () => {
    ...
    const resultState = setAsyncErrorReducer<typeof state.value>(state, SetAsyncErrorAction(FORM_CONTROL_ID, name, value));
  ...
  it('should aggregate child errors', () => {
    ...
    const resultState = setAsyncErrorReducer(state, SetAsyncErrorAction(FORM_CONTROL_INNER_ID, name, value));
  ...
  it('should aggregate child errors for group children', () => {
    ...
    const resultState = setAsyncErrorReducer(state, SetAsyncErrorAction(FORM_CONTROL_INNER3_ID, name, value));
  ...
  it('should aggregate child errors for array children', () => {
    ...
    const resultState = setAsyncErrorReducer(state, SetAsyncErrorAction(FORM_CONTROL_INNER5_ID, name, value));
  ...
  it('should aggregate multiple child errors', () => {
    ...
    let resultState = setAsyncErrorReducer(state, SetAsyncErrorAction(FORM_CONTROL_INNER_ID, name1, value1));
    resultState = setAsyncErrorReducer(resultState, SetAsyncErrorAction(FORM_CONTROL_INNER3_ID, name2, value2));
  ...
  it('should track own errors and child errors when child errors are changed', () => {
    ...
    const resultState = setAsyncErrorReducer(state, SetAsyncErrorAction(FORM_CONTROL_INNER_ID, name2, value2));
    expect(resultState.errors).toEqual({ [`$${name1}`]: value1, _inner: { [`$${name2}`]: value2 } });
  });
